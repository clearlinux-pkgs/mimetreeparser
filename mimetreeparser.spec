...
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.08.1/mimetreeparser-v24.08.1.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.08.1
cd %{_builddir}/mimetreeparser-v24.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726526291
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.2.1
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.2.1
