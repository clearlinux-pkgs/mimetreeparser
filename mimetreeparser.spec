...
Version  : 24.05.2
Release  : 6
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.05.2/mimetreeparser-v24.05.2.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.05.2/mimetreeparser-v24.05.2.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.05.2
cd %{_builddir}/mimetreeparser-v24.05.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720650645
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.1.2
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.1.2
