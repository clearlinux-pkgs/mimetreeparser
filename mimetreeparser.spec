...
Version  : 25.04.2
Release  : 16
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.2/mimetreeparser-v25.04.2.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.2/mimetreeparser-v25.04.2.tar.gz
...
%prep
%setup -q -n mimetreeparser-v25.04.2
cd %{_builddir}/mimetreeparser-v25.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749569709
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mimetreeparser-v%{version}/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/mimetreeparser/d731920113454e58292b53feedd262e531cae0f1 || :
...
cp %{_builddir}/mimetreeparser-v%{version}/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/mimetreeparser/0a5b396cd94e88c903678543771cb321992a30ba || :
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.4.2
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.4.2
...
/usr/share/package-licenses/mimetreeparser/0a5b396cd94e88c903678543771cb321992a30ba
...
/usr/share/package-licenses/mimetreeparser/d731920113454e58292b53feedd262e531cae0f1
