...
Version  : 25.04.1
Release  : 15
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.1/mimetreeparser-v25.04.1.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.1/mimetreeparser-v25.04.1.tar.gz
...
%prep
%setup -q -n mimetreeparser-v25.04.1
cd %{_builddir}/mimetreeparser-v25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747164030
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.4.1
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.4.1
