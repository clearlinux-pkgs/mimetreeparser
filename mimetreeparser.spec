...
Version  : 25.04.0
Release  : 14
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.0/mimetreeparser-v25.04.0.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v25.04.0/mimetreeparser-v25.04.0.tar.gz
...
%prep
%setup -q -n mimetreeparser-v25.04.0
cd %{_builddir}/mimetreeparser-v25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744989797
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.4.0
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.4.0
