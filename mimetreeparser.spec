...
Version  : 24.05.1
Release  : 5
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.05.1/mimetreeparser-v24.05.1.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.05.1/mimetreeparser-v24.05.1.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.05.1
cd %{_builddir}/mimetreeparser-v24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718649921
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.1.1
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.1.1
