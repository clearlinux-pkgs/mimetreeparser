...
Version  : 24.08.0
Release  : 7
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.08.0/mimetreeparser-v24.08.0.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.08.0/mimetreeparser-v24.08.0.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.08.0
cd %{_builddir}/mimetreeparser-v24.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724705492
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.2.0
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.2.0
