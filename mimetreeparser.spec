...
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.02.0/mimetreeparser-v24.02.0.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.02.0
cd %{_builddir}/mimetreeparser-v24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710520813
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.0.0
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.0.0
