...
Version  : 24.12.3
Release  : 13
URL      : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.12.3/mimetreeparser-v24.12.3.tar.gz
Source0  : https://invent.kde.org/pim/mimetreeparser/-/archive/v24.12.3/mimetreeparser-v24.12.3.tar.gz
...
%prep
%setup -q -n mimetreeparser-v24.12.3
cd %{_builddir}/mimetreeparser-v24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742566057
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim6MimeTreeParserCore.so.6.3.3
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6
/usr/lib64/libKPim6MimeTreeParserWidgets.so.6.3.3
